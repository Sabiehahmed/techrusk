      ...
      <div class="col-sm-4">
                <div class="panel panel-default">
                    ...
                    <div class="panel-heading">
                        <h3 class="panel-title">Add Banner</h3></div>
                    <div class="panel-body">
                        ...
                        <div class="form">
                            <form class="cmxform form-horizontal tasi-form" id="banner_form" method="post" action="{{url('/admin/banner_settings')}}" >
                            {!! csrf_field() !!}
                                ...
                                <div class="form-group">
                                        <div class="col-md-16">
                                          <input class="form-control" type="text" name="image"  required="required" placeholder="Category Image Url"> 
                                        </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <input class="form-control" id="alt" name="alt" type="text"  aria-required="required">
                                    </div>
                                </div>
