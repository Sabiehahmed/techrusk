     ...
     <script type="text/javascript">
            ...
            var myDropzone2 = new Dropzone("div#main_image_upload", { 
             ...
             myDropzone2.on("success",function(file, response){ 
                ...
                $('input[name="banner_image"]').val('{{url('/')}}'+response.url);
            }); 
                ...
                <div class="col-sm-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form">
                                    <form class="cmxform form-horizontal tasi-form" id="poet_from" method="post" action="{{url('/admin/banner_settings',$settings->id)}}" >
                                    {!! csrf_field() !!}
                                    ...
                                    <div class="form-group">
                                          <div class="col-md-5">
                                            <div class="dropzone" id="main_image_upload">
                                                   <div class="dz-message" data-dz-message><span>Upload Banner Picture</span></div>
                                            </div>
                                          </div>
                                    </div>
                                   ...
                                   <div class="form-group">
                                        <div class="col-md-5">
                                          <input class="form-control" type="text" name="banner_image" value="{{$settings->banner_image}}" placeholder="Banner Image Url"> 
                                        </div>
                                  </div>
